...
export class XDJUserRegisterComponent implements OnDestroy {
    ...
    constructor(fb: FormBuilder, private router: Router, public msg: NzMessageService) {
        this.form = fb.group({
            ...
            password: [null, [Validators.required, Validators.minLength(6), XDJUserRegisterComponent.checkPassword.bind(this)]],
            confirm: [null, [Validators.required, Validators.minLength(6), XDJUserRegisterComponent.passwordEquar]],
            mobilePrefix: [ '+86' ],
