...
export default {
    ...
    methods:{
        ...
        initData(){
            if (this.xdjUserInfo && this.xdjUserInfo.userId) {
               // this.avatar = this.xdjUserInfo.avatar;
                this.username = 'xdj_23jdasndio32123k';
                this.mobile = this.xdjUserInfo.userPhone || '暂无绑定手机号';
              //  this.balance = this.xdjUserInfo.balance;
               // this.count = this.xdjUserInfo.gift_amount;
              //  this.pointNumber = this.xdjUserInfo.point;
            }else{
                this.username = '登录/注册';
                this.mobile = '暂无绑定手机号';
            }
